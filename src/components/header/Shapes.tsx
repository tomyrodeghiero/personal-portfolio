...
const Shapes = () => {
  return (
    <div className={shapesStyles.shapes}>
      <svg
        width="27"
        height="29"
        className={`${shapesStyles.shape} ${shapesStyles.s1}`}
      ...
      <svg
        width="26"
        height="26"
        className={`${shapesStyles.shape} ${shapesStyles.s2}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="30"
        height="25"
        className={`${shapesStyles.shape} ${shapesStyles.s3}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="15"
        height="23"
        className={`${shapesStyles.shape} ${shapesStyles.s4}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
      ...
      <svg
        width="15"
        height="23"
        className={`${shapesStyles.shape} ${shapesStyles.s5}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
          transform="rotate(30 9.86603 10.13397)"
      ...
      <svg
        width="49"
        height="17"
        className={`${shapesStyles.shape} ${shapesStyles.s6}`}
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <svg
        width="26"
        height="26"
        className={`${shapesStyles.shape} ${shapesStyles.s7}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="19"
        height="21"
        className={`${shapesStyles.shape} ${shapesStyles.s8}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
      ...
      <svg
        width="30"
        height="25"
        className={`${shapesStyles.shape} ${shapesStyles.s9}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="47"
        height="29"
        className={`${shapesStyles.shape} ${shapesStyles.s10}`}
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <svg
        width="33"
        height="20"
        className={`${shapesStyles.shape} ${shapesStyles.s11}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
